      ...
      <div className="grid gap-8 lg:grid-cols-[1.25fr_.7fr_.7fr_1fr] lg:gap-10">
        ...
        <div>
          ...
          <div className="grid gap-3 text-sm sm:grid-cols-2 lg:grid-cols-1 lg:gap-5">
            ...
            <a href="mailto:contact@vinhworks.com" className="group flex items-center gap-3"><span className="grid h-9 w-9 place-items-center border border-zinc-900 bg-white group-hover:bg-[#ffb21c]"><Mail size={15}/></span><span className="break-all">contact@vinhworks.com</span></a>
