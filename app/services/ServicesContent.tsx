...
// import { iconMap } from "@/components/admin/SelectIconField"; // Giữ nguyên import của bạn
// MOCK iconMap để code chạy được nếu thiếu file
const iconMap: any = { Code2, LayoutTemplate, ShoppingCart, TrendingUp };
