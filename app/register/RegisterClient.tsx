...
// ─── REGISTER-SPECIFIC GRADIENTS ───────────────────────────────────────────
const gradients = {
  primary: "bg-gradient-to-r from-violet-600 via-fuchsia-500 to-pink-500",
  text: "text-transparent bg-clip-text bg-gradient-to-r from-violet-600 via-fuchsia-500 to-pink-500",
    ...
    <div className="fixed inset-0 flex overflow-hidden font-sans bg-white text-slate-900">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[-10%] right-[-10%] w-[700px] h-[700px] bg-purple-300/20 rounded-full blur-[120px] animate-blob mix-blend-multiply" />
          <div className="absolute top-[20%] left-[-10%] w-[600px] h-[600px] bg-pink-300/20 rounded-full blur-[120px] animate-blob animation-delay-2000 mix-blend-multiply" />
          <div className="absolute bottom-[-10%] left-[20%] w-[600px] h-[600px] bg-orange-300/20 rounded-full blur-[120px] animate-blob animation-delay-4000 mix-blend-multiply" />
        ...
        >
          ...
          >
            ...
            <div className="flex items-start justify-between gap-8 mb-8">
              <div className="flex-1">
                <motion.div
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 mb-5 text-sm font-bold text-purple-600 bg-white border border-purple-100 rounded-full shadow-sm"
                >
                  <Sparkles size={14} className="fill-purple-500" />
                  Nền tảng quản lý thế hệ mới
                </motion.div>

                <h1 className="text-5xl xl:text-6xl font-black tracking-tight text-slate-900 leading-[1.05]">
                  Unlock your <br />
                  <span className={gradients.text}>Potential!</span>
                </h1>
              </div>
              ...
              <div className="flex flex-col gap-3 shrink-0 pt-2">
                {[
                  ...
                  { value: "99%", label: "Uptime", color: "text-fuchsia-500" },
            ...
            <p className="mb-7 text-base font-medium leading-relaxed text-slate-600 max-w-md">
              Tham gia cộng đồng công nghệ hàng đầu. Truy cập kho{" "}
              <span className="font-bold text-purple-600">tài nguyên</span>{" "}
              khổng lồ và các{" "}
              <span className="font-bold text-pink-600">công cụ</span> phát
              triển độc quyền.
            </p>
          ...
          <div className="flex gap-4 mt-5">
            ...
            >
              <div className="p-2 rounded-xl bg-gradient-to-br from-purple-100 to-fuchsia-100 text-purple-600">
                <Code2 size={18} />
              </div>
              <div>
                <p className="text-sm font-black text-slate-800">Clean Code</p>
                <p className="text-[11px] text-slate-400 font-medium">
                  Kiến trúc chuẩn & bảo trì dễ
                </p>
              </div>
            </motion.div>
      ...
      <motion.div
        ...
        className="flex w-full lg:w-[42%] bg-white border-l border-slate-100 items-center justify-center shadow-[-20px_0_60px_rgba(0,0,0,0.03)] overflow-y-auto"
      >
        <div className="w-full max-w-sm px-8 py-10 space-y-5">
          {/* Mobile logo */}
          ...
          <div>
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 mb-4 text-sm font-bold text-purple-600 bg-white border border-purple-100 rounded-full shadow-sm"
            >
              <Sparkles size={14} className="fill-purple-500" />
              Tạo tài khoản mới
            </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              <label
                className={`text-xs font-bold uppercase tracking-wider transition-colors ${nameFocused ? "text-violet-600" : "text-slate-500"}`}
              >
                Họ và Tên
              </label>
              <div className="relative">
                <div
                  className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors duration-300 ${nameFocused ? "text-violet-500" : "text-slate-400"}`}
                >
                  <User size={17} />
                </div>
                <input
            ...
            <motion.button
              ...
              whileHover={{
                scale: 1.02,
                boxShadow: "0 20px 40px -12px rgba(139,92,246,0.45)",
              }}
              whileTap={{ scale: 0.97 }}
              disabled={loading}
              type="submit"
              className="relative w-full py-3.5 font-bold text-white rounded-2xl bg-violet-600 hover:bg-violet-700 shadow-lg shadow-violet-500/25 transition-all flex items-center justify-center gap-3 text-sm disabled:opacity-70 disabled:cursor-not-allowed overflow-hidden group"
            >
